...
public class ActivityDataKosmetik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_kosmetik);
        ...
        newsList.clear();
        adapter = new AdapterKosmetik(ActivityDataKosmetik.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(ActivityDataKosmetik.this, HomeAdminActivity.class);
        startActivity(i);
        finish();
    }
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(ActivityDataKosmetik.this, EditKosmetikDanHapusActivity.class);
